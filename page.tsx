...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// GIFT CATALOG
// Each item has: id, category, emoji, title, affiliate (null = placeholder)
// writeinLabel: if set, selecting this opens a custom text input
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
const GIFT_CATALOG = [
  // ── Beauty & Wellness ──────────────────────────────────────────
  ...
  { id: "c03", category: "Beauty & Wellness", emoji: "🕯️", title: "Luxury Candle of My Choosing", affiliate: null, writeinLabel: "Which candle brand? (e.g. Diptyque, Maison Margiela)" },
  { id: "c04", category: "Beauty & Wellness", emoji: "🛁", title: "Fancy Bath Set of My Choosing", affiliate: null, writeinLabel: "Any specific products or brands?" },
  { id: "c05", category: "Beauty & Wellness", emoji: "💅", title: "Manicure & Pedicure Voucher", affiliate: null },
  { id: "c06", category: "Beauty & Wellness", emoji: "🌸", title: "Fragrance of My Choosing", affiliate: null, writeinLabel: "Specific scent or just your pick?" },
  { id: "c07", category: "Beauty & Wellness", emoji: "💆", title: "Skincare Set of My Choosing", affiliate: null, writeinLabel: "Brand preference? (e.g. Tatcha, Drunk Elephant)" },
  { id: "c08", category: "Beauty & Wellness", emoji: "💇", title: "Hair Tool of My Choosing", affiliate: null, writeinLabel: "e.g. Dyson, GHD, T3" },

  // ── Food & Drink ───────────────────────────────────────────────
  { id: "c09", category: "Food & Drink", emoji: "🍣", title: "Emergency Sushi Delivery", affiliate: null },
  { id: "c10", category: "Food & Drink", emoji: "🍽️", title: "Dinner Reservation at My Choosing", affiliate: null },
  { id: "c11", category: "Food & Drink", emoji: "🛵", title: "Uber Eats Credit ($40+)", affiliate: null },
  { id: "c12", category: "Food & Drink", emoji: "🍵", title: "Matcha & Pastry Tribute", affiliate: null },
  { id: "c13", category: "Food & Drink", emoji: "☕", title: "Weekend Coffee Pilgrimage", affiliate: null },
  { id: "c14", category: "Food & Drink", emoji: "🥂", title: "Bottle of Wine of My Choosing", affiliate: null, writeinLabel: "Red, white, rosé? Any preference you'll note?" },
  { id: "c15", category: "Food & Drink", emoji: "🍫", title: "Luxury Chocolate Box of My Choosing", affiliate: null, writeinLabel: "e.g. Compartés, Vosges, or your pick" },
  { id: "c16", category: "Food & Drink", emoji: "☕", title: "Coffee Subscription of My Choosing", affiliate: null, writeinLabel: "e.g. Trade Coffee, Blue Bottle" },

  // ── Experiences ────────────────────────────────────────────────
  { id: "c17", category: "Experiences", emoji: "🌹", title: "Flowers + Handwritten Apology", affiliate: null },
  { id: "c18", category: "Experiences", emoji: "🎬", title: "Movie Night (You Plan Everything)", affiliate: null },
  { id: "c19", category: "Experiences", emoji: "🎨", title: "Activity of My Choosing", affiliate: null, writeinLabel: "What activity are you thinking?" },
  { id: "c20", category: "Experiences", emoji: "🚗", title: "Designated Driver for a Night", affiliate: null },
  { id: "c21", category: "Experiences", emoji: "🧹", title: "Full Apartment Clean (By You)", affiliate: null },
  { id: "c22", category: "Experiences", emoji: "🎭", title: "Event Tickets of My Choosing", affiliate: null, writeinLabel: "e.g. concert, comedy show, museum" },

  // ── Home & Lifestyle ───────────────────────────────────────────
  { id: "c23", category: "Home & Lifestyle", emoji: "🛋️", title: "Throw Blanket of My Choosing", affiliate: null, writeinLabel: "Any color or brand preference?" },
  { id: "c24", category: "Home & Lifestyle", emoji: "🍳", title: "Kitchen Item of My Choosing", affiliate: null, writeinLabel: "e.g. Le Creuset, specific gadget" },
  { id: "c25", category: "Home & Lifestyle", emoji: "🌿", title: "Plant + Pot of My Choosing", affiliate: null },

  // ── Fashion ────────────────────────────────────────────────────
  { id: "c26", category: "Fashion", emoji: "👗", title: "Accessory of My Choosing (Under $150)", affiliate: null, writeinLabel: "Category? e.g. bag, jewelry, scarf" },
  { id: "c27", category: "Fashion", emoji: "👟", title: "Sneakers of My Choosing", affiliate: null, writeinLabel: "Style or brand preference?" },
  { id: "c28", category: "Fashion", emoji: "🕶️", title: "Sunglasses of My Choosing", affiliate: null, writeinLabel: "Brand or style preference?" },

  // ── Cash & Cards ───────────────────────────────────────────────
  { id: "c29", category: "Cash & Cards", emoji: "💸", title: "Venmo Tribute ($50)", affiliate: null },
  { id: "c30", category: "Cash & Cards", emoji: "🛍️", title: "Amazon Gift Card ($50)", affiliate: null },
  { id: "c31", category: "Cash & Cards", emoji: "✈️", title: "Travel Fund Contribution ($100)", affiliate: null },
  { id: "c32", category: "Cash & Cards", emoji: "📚", title: "Book Bundle of My Choosing", affiliate: null, writeinLabel: "Genre or specific titles you have in mind?" },

  // ── Luxury ─────────────────────────────────────────────────────
  { id: "c33", category: "Luxury", emoji: "👜", title: "Designer Item of My Choosing (Under $200)", affiliate: null, writeinLabel: "Brand or category?" },
  { id: "c34", category: "Luxury", emoji: "💎", title: "Jewelry of My Choosing", affiliate: null, writeinLabel: "Style, metal, budget cap?" },
  { id: "c35", category: "Luxury", emoji: "🌿", title: "Premium Skincare Product of My Choosing", affiliate: null, writeinLabel: "Brand or product type?" },
  { id: "c36", category: "Luxury", emoji: "🎁", title: "Mystery Compensation Package", affiliate: null },
];
...
const css = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .slot-writein { font-size: 11px; color: var(--text-3); margin-top: 0.35rem; font-style: italic; }
  ...
  .success-msg { font-size: 11px; color: var(--green); margin-top: 0.35rem; letter-spacing: 0.08em; }
  .error-msg { font-size: 11px; color: var(--red); margin-top: 0.35rem; letter-spacing: 0.08em; }
  .field-error { font-size: 10px; color: var(--red); margin-top: 0.25rem; letter-spacing: 0.06em; }
  /* Star rating */
  .stars { display: flex; gap: 0.5rem; justify-content: center; margin: 0.75rem 0; }
  .star { font-size: 1.75rem; cursor: pointer; transition: transform 0.1s; opacity: 0.3; }
  .star.active { opacity: 1; }
  .star:hover { transform: scale(1.15); }
  /* Notification toggle */
  .toggle-row { display: flex; align-items: center; justify-content: space-between; padding: 0.75rem 1rem; background: rgba(255,255,255,0.03); border: 1px solid var(--border); border-radius: var(--radius-sm); cursor: pointer; }
...
function GiftSlot({ index, value, onChange, usedIds }: any) {
  ...
  const [writeinNote, setWriteinNote] = useState(value?.writeinNote || "");
  const categories = [...new Set(GIFT_CATALOG.map((g: any) => g.category))];

  const selectedCatalogItem = value && !value.custom ? GIFT_CATALOG.find(g => g.id === value.id) : null;
  const hasWritein = selectedCatalogItem && (selectedCatalogItem as any).writeinLabel;

  const handleSelect = (e: any) => {
    const id = e.target.value;
    if (id === "other") { setMode("custom"); onChange(null); setWriteinNote(""); return; }
    if (!id) { onChange(null); setWriteinNote(""); return; }
    const gift = GIFT_CATALOG.find(g => g.id === id);
    setWriteinNote("");
    onChange(gift ? { ...gift } : null);
  };

  const handleWriteinNote = (val: string) => {
    setWriteinNote(val);
    if (value) onChange({ ...value, writeinNote: val });
  };
    ...
    <div className="gift-slot">
      ...
      {mode === "catalog" ? (
        <>
          ...
          {hasWritein && (
            <div style={{ marginTop: "0.5rem" }}>
              <p className="slot-writein">{(selectedCatalogItem as any).writeinLabel}</p>
              <input
                className="input"
                style={{ marginTop: "0.35rem", fontSize: "12px", padding: "0.55rem 0.85rem" }}
                placeholder="Optional note (seen only by you)"
                value={writeinNote}
                onChange={e => handleWriteinNote(e.target.value)}
              />
            </div>
          )}
        </>
        ...
        <div className="gap-sm">
          ...
          <input className="input" placeholder="Link (optional — product, booking, etc.)" value={customLink} onChange={e => setCustomLink(e.target.value)} />
          <div className="row">
            <button className="btn btn-gold btn-sm" onClick={handleCustomSave}>Save</button>
            <button className="btn btn-ghost btn-sm" onClick={() => { setMode("catalog"); onChange(null); }}>← Back to catalog</button>
          </div>
...
export default function App() {
  ...
  // Sender — Link ready step: email + notifications opt-in
  const [senderEmail, setSenderEmail] = useState("");
  const [notifyOnSpin, setNotifyOnSpin] = useState(true);
  const [notifyOnVenmo, setNotifyOnVenmo] = useState(true);
  ...
  // Save sender email + notification prefs to Supabase after link is generated
  const saveNotificationPrefs = async () => {
    if (!senderEmail.trim()) return;
    setSavingEmail(true);
    await supabase.from("roulettes").update({
      sender_email: senderEmail.trim(),
      notify_on_spin: notifyOnSpin,
      notify_on_venmo: notifyOnVenmo,
    }).eq("code", activeCode);
  ...
  const submitFeedback = async () => {
    ...
    try {
      await fetch("/api/send-feedback", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ rating: feedbackRating, feedback: feedbackText, code: activeCode }),
      });
    } catch (e) {}
  ...
  const spin = async () => {
    ...
    const iv = setInterval(async () => {
      ...
      if (t <= 0) {
        ...
        setIsSpinning(false);
        setResultKey(k => k + 1);
        if (receiverSenderEmail && notifyOnSpin) {
          try {
            await fetch("/api/notify-spin", {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({ senderEmail: receiverSenderEmail, senderName: receiverSenderName, giftTitle: g.title, giftEmoji: g.emoji }),
            });
          } catch (e) {}
        }
      }
  ...
  const handleVenmoRefusal = async () => {
    if (receiverSenderEmail && receiverNotifyOnVenmo) {
      try {
        await fetch("/api/notify-spin", {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
            ...
            giftTitle: "Venmo Payment (Refused All Outcomes)",
            giftEmoji: "💸",
          }),
        });
      } catch (e) {}
  ...
  const venmoHandle = senderVenmo ? senderVenmo.replace(/^@+/, "") : "";
            ...
            {purchaseStep === "form" ? (
              <>
                ...
                <div className="gap mt2">
                  <button className="btn btn-gold" onClick={() => { if (purchaseName && purchaseEmail) setPurchaseStep("pay"); }} disabled={!purchaseName || !purchaseEmail}>Continue to Payment →</button>
              ...
              <>
                ...
                <p className="sub mb1">Send <strong style={{ color: "var(--gold)" }}>${OWNER_VENMO_AMOUNT}</strong> to the Venmo below. Your code will be emailed to <strong style={{ color: "var(--gold)" }}>{purchaseEmail}</strong> once confirmed.</p>
                ...
                <p className="sub center" style={{ marginBottom: "1rem", fontSize: "11px" }}>Your code arrives by email within minutes of payment.</p>
          ...
          <div className={`card card-accent ${pwError || codeError ? "shake" : ""}`}>
            ...
            {entryMode === "code" ? (
              <div className="gap-sm">
                ...
                <p className="sub center" style={{ marginTop: "0.5rem" }}>Don't have a code?{" "}<span onClick={() => { setShowPurchaseModal(true); setPurchaseStep("form"); }} style={{ color: "var(--gold)", cursor: "pointer", textDecoration: "underline" }}>Purchase access →</span></p>
              </div>
            ) : (
              <div className="gap-sm">
        ...
        <div className="wrap">
          ...
          <div className="card card-accent">
            ...
            <div className="gap-sm">
              ...
              <input
                className={`input ${senderNameError ? "input-error" : ""}`}
                placeholder="e.g. The Aggrieved Party"
                value={senderName}
                onChange={e => { setSenderName(e.target.value); if (e.target.value) setSenderNameError(false); }}
              />
              {senderNameError && <p className="field-error">Name is required to generate a link.</p>}
              ...
              <div className="input-wrap">
                ...
                <input
                  ...
                  value={senderVenmo.startsWith("@") ? senderVenmo.slice(1) : senderVenmo}
                  onChange={e => setSenderVenmo(e.target.value.replace(/^@/, ""))}
                />
              </div>
          ...
          <div className="card">
            ...
            <p className="sub mb1">Choose 10 unique gifts. Pick from the catalog — some let you add a personal note. Use "Other" to write your own.</p>
            <div className="gap">
          ...
          <div className="gap">
            <button className="btn btn-gold" onClick={goPreview} disabled={filledGifts.length < 10}>
              Preview My Roulette →
            </button>
            <p className="sub center">{filledGifts.length}/10 gifts selected{!senderName.trim() ? " · Name required above" : ""}</p>
          </div>
    ...
    <>
      ...
      <div className="app">
        <div className="wrap fadein">
          ...
          {/* Notification opt-in — email collected HERE */}
          <div className="card">
            <p className="eyebrow">Spin Notifications</p>
            <p className="sub mb1">Get emailed every time your roulette is spun or when they choose to pay instead.</p>
            ...
            {!emailSaved ? (
              <div className="gap-sm">
                ...
                <div style={{ marginTop: "0.5rem" }} className="gap-sm">
                  <div className="toggle-row" onClick={() => setNotifyOnSpin(p => !p)}>
                    <span className="toggle-label">Email me when they spin the wheel</span>
                    <div className={`toggle ${notifyOnSpin ? "on" : ""}`} />
                  </div>
                  <div className="toggle-row" onClick={() => setNotifyOnVenmo(p => !p)}>
                    <span className="toggle-label">Email me if they choose to pay instead</span>
                    <div className={`toggle ${notifyOnVenmo ? "on" : ""}`} />
                  </div>
                </div>

                <button
                  className="btn btn-ghost mt1"
                  onClick={saveNotificationPrefs}
                  disabled={!senderEmail.trim() || savingEmail}
                >
                  {savingEmail ? "Saving..." : "Save Notification Preferences"}
                </button>
              </div>
            ) : (
              <p className="success-msg center">✓ You'll be notified at {senderEmail}</p>
            )}
          </div>
          ...
          <div className="card">
            ...
            <p className="sub center mb1">How was your experience building this roulette?</p>
            <div className="stars">
              {[1,2,3,4,5].map(n => (
                <span
                  key={n}
                  className={`star ${n <= (feedbackHover || feedbackRating) ? "active" : ""}`}
            ...
            {feedbackRating > 0 && !feedbackSent && (
              <div className="gap-sm fadein">
                <textarea
                  className="input"
                ...
                />
                <button className="btn btn-ghost btn-sm" onClick={submitFeedback} disabled={sendingFeedback}>
                  {sendingFeedback ? "Sending..." : "Submit Feedback"}
                </button>
              </div>
            )}
            {feedbackSent && <p className="success-msg center">✓ Thank you. The chamber appreciates your input.</p>}
          </div>
          ...
          <div className="card card-accent">
            ...
            <div className="gap">
              ...
              {(spinsLeft <= 0 || selectedGift) && !isSpinning && senderVenmoLink && (
                <a
                  href={senderVenmoLink}
                  target="_blank"
                  rel="noreferrer"
                  onClick={handleVenmoRefusal}
